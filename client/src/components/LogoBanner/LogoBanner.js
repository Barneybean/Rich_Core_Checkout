        ...
        <div id="logo" className="pt-0 mx-0 bg-white">
            <div className="row">
                <div className="col-md-8 pb-2 pt-2 align-items-center logo">
                    <a href="/"><img className="pl-2" src={logo} height="90px" width="400px" alt="America Claude University Logo" /></a>
                </div>
                ...
                <div className="col-md-2">
                    {loggedInId === "loggedOut" ? (
                        <a href="/login"><div id="loginState"><i class="fa fa-lock" aria-hidden="true"></i></div></a>
                    ) : (
                            <div>
                                <div id="loginState"
                                    onClick={logOut}
